 ...
 *
 *   mocha --recursive --timeout 150000 -g "group by on fk column in json aggregates and add _id if fk column" --reporter spec
 */
...
//TODO do we need to apply having on inner group
        ...
        it("group by on n Fk column more than one with having and sort and aggregates and data and array ", function (done) {
