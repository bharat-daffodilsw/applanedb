...
var configureOptions = {url:"mongodb://127.0.0.1:27017", admin:{db:"northwindadmindb", username:"northiwndadmin", password:"1234"}};
...
describe("MergingLocalAndAdminDbtestcase", function () {
    ...
    describe("UpdateCase", function () {
        ...
        it.skip("status override", function (done) {
            ApplaneDB.connect(ApplaneDBConfig.URL, ApplaneDBConfig.Admin.DB, function (err, adminDb) {
                if (err) {
                    done(err);
                    return;
        ...
        it.skip("persons override with unwind person on localdb", function (done) {
            ApplaneDB.connect(ApplaneDBConfig.URL, ApplaneDBConfig.Admin.DB, function (err, adminDb) {
                if (err) {
                    done(err);
                    return;
                    ...
                    adminDb.batchUpdateById(adminCollection, function (err) {
                        ...
                        localDb1.batchUpdateById(localCollection, function (err) {
                            ...
                            localDb1.batchUpdateById(localCollection1, function (err) {
                                ...
                                localDb1.db.collection("__collections__").find().toArray(function (err, localResult) {
                                    if (err) {
                                        done(err);
                                        return;
                                    }
                                    ...
                                    expect(localResult[0].triggers[0]._id).to.eql("t2");
                                    expect(localResult[0].triggers[0].name).to.eql("t2");
                                    ...
                                    expect(localResult[0].triggers[1]._id).to.eql("t1");
                                    expect(localResult[0].triggers[1].name).to.eql(undefined);
                                    expect(localResult[0].triggers[1].source).to.eql(undefined);
                                    ...
                                    expect(localResult[0].triggers[1].__type__).to.eql("delete");
                                    ...
                                    expect(localResult[0].triggers[3].__type__).to.eql(undefined);
                                    ...
                                    localDb1.query({$collection:"__collections__"}, function (err, mainResult) {
                                        if (err) {
                                            done(err);
                                            return;
                                        }
...
//                                        expect(mainResult.result[0].triggers[3].source).to.eql(undefined);
                                        ...
                                        expect(mainResult.result[0].triggers[3].__type__).to.eql(undefined);
                                        ...
                                        expect(mainResult.result[0].triggers[4].__type__).to.eql(undefined);
    ...
    describe("QueryCase", function () {
        ...
        it.skip("menus merging", function (done) {
            ApplaneDB.connect(ApplaneDBConfig.URL, ApplaneDBConfig.Admin.DB, function (err, adminDb) {
                if (err) {
                    done(err);
                    return;
        ...
        it.skip("menus merging in two databases", function (done) {
            ApplaneDB.connect(ApplaneDBConfig.URL, ApplaneDBConfig.Admin.DB, function (err, adminDb) {
                if (err) {
                    done(err);
                    return;
...
//                                        expect(localMenus[0].__type__).to.eql("insert");
        ...
        it.skip("menus merging with sorting by index after merging", function (done) {
            ApplaneDB.connect(ApplaneDBConfig.URL, ApplaneDBConfig.Admin.DB, function (err, adminDb) {
                if (err) {
                    done(err);
                    return;
        ...
        it.skip("status override with status on localdb", function (done) {
            ApplaneDB.connect(ApplaneDBConfig.URL, ApplaneDBConfig.Admin.DB, function (err, adminDb) {
                if (err) {
                    done(err);
                    return;
        ...
        it.skip("status override with no status on localdb", function (done) {
            ApplaneDB.connect(ApplaneDBConfig.URL, ApplaneDBConfig.Admin.DB, function (err, adminDb) {
                if (err) {
                    done(err);
                    return;
        ...
        it.skip("persons override with person on localdb", function (done) {
            ApplaneDB.connect(ApplaneDBConfig.URL, ApplaneDBConfig.Admin.DB, function (err, adminDb) {
                if (err) {
                    done(err);
                    return;
        ...
        it.skip("persons override with no person on localdb", function (done) {
            ApplaneDB.connect(ApplaneDBConfig.URL, ApplaneDBConfig.Admin.DB, function (err, adminDb) {
                if (err) {
                    done(err);
                    return;
        ...
        it.skip("persons override with unwind no person on localdb", function (done) {
            ApplaneDB.connect(ApplaneDBConfig.URL, ApplaneDBConfig.Admin.DB, function (err, adminDb) {
                if (err) {
                    done(err);
                    return;
        ...
        it.skip("Array case add trigger in collections", function (done) {
            //assuming triggers are saved in collection
