                        ...
                        if (err) {
                            ...
                            db.query({$collection: "invoices"}, function (err, data) {
                                if (err) {
                                    ...
                                    expect(data.result[0].invoicelineitems[2].purchases[1].productid.name).to.eql("laptop");
                                    expect(data.result[0].invoicelineitems[2].purchases[1].productid.type).to.eql("portabledevice");
                                    expect(data.result[0].invoicelineitems[2].purchases[1].productid.accountid.name).to.eql("PNB");
                                    expect(data.result[0].invoicelineitems[2].purchases[1].productid.accountid.type).to.eql("expense");
                                    expect(data.result[0].invoicelineitems[2].purchases[1].productid.accountid.accountgroupid.name).to.eql("Expense");

                                    expect(data.result[0].invoicelineitems[1].purchases).to.have.length(3);
                                    console.log("CCCCCCCCCCCCCCCCCCCC>>>" + JSON.stringify(data.result[0].invoicelineitems[1].purchases));
                                    ...
                                    expect(data.result[0].invoicelineitems[1].purchases[2].productid.name).to.eql("computer");
                                    expect(data.result[0].invoicelineitems[1].purchases[2].productid.type).to.eql("device");
